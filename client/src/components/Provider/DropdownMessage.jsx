  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`absolute -right-16 top-12 flex h-80 w-72 flex-col rounded-sm  bg-sky-100 shadow-md z-40 sm:right-0 sm:w-80 ${
      ...
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto invisible-scrollbar">
          <li>
            <Link
              className="flex gap-4 px-4 py-3 hover:bg-gray-100 "
              to="/messages"
            >
          ...
          <li>
            <Link
              className="flex gap-4 border-t px-4 py-3 hover:bg-gray-100 "
              to="/messages"
            >
              <div className="h-12 w-12 rounded-full">
