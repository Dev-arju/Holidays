...
const EditPriceOption = () => {
  ...
  useEffect(() => {
    const getPriceOptions = async () => {
      ...
      if (response.data) {
        setPlanOptions(response.data.priceOptions);
      }
      if (response.error) {
    ...
    <div>
      ...
      <div className="mt-16 flex justify-center">
        <button
          ...
          className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-green-300 shadow-lg shadow-green-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
        >
          Finish & Save
        </button>
      </div>
...
export default EditPriceOption;
